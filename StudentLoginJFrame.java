...
public class StudentLoginJFrame extends javax.swing.JFrame {
 ...
 String studentID = txtStudentID.getText().trim();
    ...
    try (Connection con = DBconnection.connect();
        ...
        if (rs.next()) {
            // ✅ Login successful, open MajorStudentJFrame and pass studentID
            MajorStudentJFrame majorFrame = new MajorStudentJFrame(studentID);
            majorFrame.setVisible(true);
            this.dispose(); // Close login window
        } else {
            JOptionPane.showMessageDialog(null, "Invalid StudentID or Password.");
        }
